...
export default function AboutPage() {
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <section className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-16">
                <div className="max-w-[1200px] mx-auto px-4 text-center">
                    ...
                    <p className="text-lg max-w-2xl mx-auto opacity-90">
                        Nền tảng mua sắm phụ kiện thời trang trực tuyến được phát triển bởi sinh viên UTE —
                        nơi mang đến trải nghiệm mua sắm tiện lợi, hiện đại và bảo mật cho mọi người.
                    </p>
                </div>
            </section>
            ...
            <section className="max-w-[1200px] mx-auto px-4 py-16">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        UTE Shop ra đời với mục tiêu mang đến những sản phẩm phụ kiện thời trang chất lượng, giá cả hợp lý và dịch vụ chăm sóc khách hàng tận tâm.
                        Chúng tôi không chỉ tạo ra một website bán hàng, mà còn tạo ra một hệ thống hoàn chỉnh cho sinh viên học tập và thực hành.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10">
                    <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
                        <img src="/icons/quality.svg" alt="Chất lượng" className="w-12 h-12 mb-3 mx-auto" />
                        <h3 className="text-xl font-semibold mb-2 text-center">Chất lượng</h3>
                        <p className="text-gray-600 text-center">
                            Sản phẩm được chọn lọc kỹ lưỡng, đảm bảo chất lượng cao và thông tin rõ ràng.
                        </p>
                    </div>
                    <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
                        <img src="/icons/security.svg" alt="Bảo mật" className="w-12 h-12 mb-3 mx-auto" />
                        <h3 className="text-xl font-semibold mb-2 text-center">Bảo mật</h3>
                        <p className="text-gray-600 text-center">
                            UTE Shop áp dụng chuẩn bảo mật (CSRF, JWT) đảm bảo an toàn cho thông tin người dùng.
                        </p>
                    </div>
                    <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
                        <img src="/icons/support.svg" alt="Hỗ trợ" className="w-12 h-12 mb-3 mx-auto" />
                        <h3 className="text-xl font-semibold mb-2 text-center">Hỗ trợ 24/7</h3>
                        <p className="text-gray-600 text-center">
                            Đội ngũ sẵn sàng hỗ trợ khách hàng nhanh chóng qua nhiều kênh liên lạc.
                        </p>
                    </div>
                </div>
            </section>
            ...
            {/* Team Section */}
            <section className="max-w-[1200px] mx-auto px-4 py-16">
                <h2 className="text-3xl font-bold text-center text-gray-800 mb-10">Đội ngũ phát triển</h2>
            ...
            <section className="bg-indigo-600 text-white py-12">
                <div className="max-w-[800px] mx-auto text-center">
                    <h2 className="text-3xl font-bold mb-4">Trải nghiệm UTE Shop ngay hôm nay</h2>
